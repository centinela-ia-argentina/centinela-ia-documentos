...
export const navigation: NavItem[] = [
  ...
  { name: 'Modelos', href: '/modelos', icon: FileSignature, roles: ['admin', 'employee', 'auditor', 'client'], industries: ['legal', 'escribania', 'inmobiliaria'], group: 'Herramientas jurídicas', description: 'Plantillas y modelos de documentos.' },
