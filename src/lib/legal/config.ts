...
export const LEGAL_PARAMETERS: Record<string, GovernedParameter> = {
  tasa_justicia_nacion: {
    ...
    sourceUrl: 'https://servicios.infoleg.gob.ar/infolegInternet/anexos/0-4999/408/texact.htm',
    ...
    fuente: 'Ley 23.898',
    url: 'https://servicios.infoleg.gob.ar/infolegInternet/anexos/0-4999/408/texact.htm',
  ...
  jus_corrientes: {
    ...
    url: 'https://www.juscorrientes.gov.ar/',
    verification_status: 'pendiente',
