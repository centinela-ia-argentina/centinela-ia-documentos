-- ==============================================================================
-- MIGRATION: 20260818130000_match_case_document_chunks
-- ==============================================================================

BEGIN;

-- Drop the insecure function first
DROP FUNCTION IF EXISTS public.match_case_document_chunks(uuid, uuid, vector, double precision, integer);
